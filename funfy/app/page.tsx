    ...
    <div className="flex flex-col flex-1 h-[100dvh] bg-slate-50 overflow-hidden">
      ...
      <header className="h-16 flex items-center justify-between px-4 md:px-6 bg-white border-b border-slate-200 shadow-sm z-10 shrink-0">
        ...
        <div className="flex items-center gap-2 md:gap-4">
          <button className="flex items-center gap-1.5 md:gap-2 px-3 md:px-4 py-2 rounded-full hover:bg-slate-100 text-slate-700 font-medium transition-colors text-sm md:text-base" onClick={addDieCutOutline}>
            <Scissors size={18} />
